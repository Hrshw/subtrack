...
const RobotChatCache_1 = require("../models/RobotChatCache");
    ...
    static getRobotSpeech(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const now = new Date();
                // Check cache
                const cache = yield RobotChatCache_1.RobotChatCache.findOne({ userId });
                ...
                if (shouldShowGreeting) {
                    ...
                    yield RobotChatCache_1.RobotChatCache.findOneAndUpdate({ userId }, {
                        userId,
                        lastMessage: greeting,
                        timestamp: now,
                        isPro,
                        messageCount: (cache === null || cache === void 0 ? void 0 : cache.messageCount) || 0,
                        lastResetAt: (cache === null || cache === void 0 ? void 0 : cache.lastResetAt) || now,
                ...
                // Get real scan data
                const scanResults = yield ScanResult_1.ScanResult.find({ userId }).sort({ createdAt: -1 }).limit(10).catch(() => []);
...
Example output: "I'm your app-tracking buddy, click to explore!"`;
                ...
                let message = yield this.generateWithOpenRouter(prompt, {
                    temperature: 0.9,
                    max_tokens: 50,
                    top_p: 0.95,
                });
     ...
     */
    static handleChatMessage(userId, userMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const user = yield User_1.User.findById(userId);
                if (!user)
                    return { message: "Login to chat with me!", shouldUpgrade: false };
                const isPro = user.subscriptionStatus === 'pro';
                const now = new Date();
                // Get or create cache
                let cache = yield RobotChatCache_1.RobotChatCache.findOne({ userId });
                if (!cache) {
                    cache = yield RobotChatCache_1.RobotChatCache.create({
                        userId,
                        lastMessage: '',
                        timestamp: now,
                        isPro,
                ...
                const userName = user.name || ((_a = user.email) === null || _a === void 0 ? void 0 : _a.split('@')[0]) || 'there';
...
${!isPro ? `- User has ${remainingMessages - 1} messages left today.` : ''}`;
     ...
     */
    static generateWithOpenRouter(prompt, options) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            ...
            for (const model of ROBOT_MODEL_PRIORITY_LIST) {
                try {
                    ...
                    if (response.ok) {
                        ...
                        const rawText = (_d = (_c = (_b = (_a = data.choices) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content) === null || _d === void 0 ? void 0 : _d.trim();
                        if (rawText) {
